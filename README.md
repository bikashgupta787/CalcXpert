A Multi-functional calculator app using Kotlin, XML, and View Binding that supports standard calculations and metric-based conversions (e.g. age, temperature, bmi, speed).
